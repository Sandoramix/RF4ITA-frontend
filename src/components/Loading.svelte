...
<div>
	<p bind:this={errorMsg} id="loading-msg">If the loading is blocked, please reload the page</p>
	<svg
		...
		><g
			><path
				...
				fill="#ffffff"
			/><animateTransform attributeName="transform" type="rotate" from="0 64 64" to="120 64 64" dur="840ms" repeatCount="indefinite" /></g
		></svg
	>
</div>
